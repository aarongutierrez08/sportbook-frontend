...
const MyDataPage: React.FC = () => {
  ...
  const checkForChanges = (currentData: UpdateUserDataParams): boolean => {
    ...
    return (
      ...
      currentData.phoneNumber !==
        (loggedUser.additionalInfo?.phoneNumber || "") ||
      ...
      currentData.gender !==
        (loggedUser.additionalInfo?.gender || "PREFER_NOT_TO_SAY") ||
      JSON.stringify(currentData.languages) !==
        JSON.stringify(loggedUser.additionalInfo?.languages || [])
    );
  };
  ...
  const getFieldValue = (field: string): string => {
    ...
    if (field === "gender")
      return loggedUser?.additionalInfo?.gender || "PREFER_NOT_TO_SAY";
    if (field === "languages")
      return loggedUser?.additionalInfo?.languages?.join(", ") || "";
  ...
  const generalInformationCard = () => {
    return (
      <div className="my-data-info-card">
        <div className="my-data-card-header">Información general</div>
        <div className="info-item">
          ...
          >
            ...
            />
            <path
              d="M20.5934 22C20.5934 18.13 16.7734 15 12.0001 15C7.22672 15 3.40674 18.13 3.40674 22"
              stroke="currentColor"
              strokeWidth="2"
              strokeLinecap="round"
              strokeLinejoin="round"
          ...
          {editingField === "name" ? (
            <span>
              ...
              <input
                ...
                onKeyDown={(e) =>
                  e.key === "Enter" ? stopEditingField() : undefined
                }
              />
            </span>
          ) : (
            <span onClick={() => startEditingField("name")}>
              Nombre: {getFieldValue("name")}
            </span>
          )}
        </div>
        <div className="info-item">
          ...
          {editingField === "lastName" ? (
            ...
            <span onClick={() => startEditingField("lastName")}>
              Apellido: {getFieldValue("lastName")}
            </span>
          )}
        </div>
        <div className="info-item">
          ...
          {editingField === "dateOfBirth" ? (
            ...
            <span onClick={() => startEditingField("dateOfBirth")}>
              Fecha de nacimiento: {formatDate(getFieldValue("dateOfBirth"))}
            </span>
          )}
        </div>
        <div className="info-item">
          ...
          {editingField === "email" ? (
            ...
            <span onClick={() => startEditingField("email")}>
        ...
        <div className="info-item">
          ...
          {editingField === "role" ? (
            ...
            <span onClick={() => startEditingField("role")}>
              Rol: {mapRole(getFieldValue("role"))}
            </span>
          )}
        </div>
      </div>
  ...
  const profilePictureCard = () => {
    return (
      <div className="my-data-profile-card">
        <div className="my-data-card-header">Foto de perfil</div>
        <div className="profile-picture-container">
          {image ? (
            <img src={image} alt="ProfilePicture" className="profile-picture" />
          ) : (
  ...
  const aboutMeCard = () => {
      ...
      <>
        <div className="info-item">
          ...
          {editingField === "phoneNumber" ? (
            ...
            <span onClick={() => startEditingField("phoneNumber")}>
              Número de teléfono: {getFieldValue("phoneNumber") || ""}
            </span>
          )}
        </div>
        <div className="info-item">
          ...
          {editingField === "country" ? (
            ...
            <span onClick={() => startEditingField("country")}>
              País: {getFieldValue("country") || ""}
            </span>
          )}
        </div>
        <div className="info-item">
          ...
          {editingField === "city" ? (
            ...
            <span onClick={() => startEditingField("city")}>
              Ciudad: {getFieldValue("city") || ""}
            </span>
          )}
        </div>
        <div className="info-item">
          ...
          {editingField === "address" ? (
            ...
            <span onClick={() => startEditingField("address")}>
              Dirección: {getFieldValue("address") || ""}
            </span>
          )}
        </div>
        <div className="info-item">
          ...
          {editingField === "gender" ? (
            ...
            <span onClick={() => startEditingField("gender")}>
              Género: {mapGender(getFieldValue("gender")) || ""}
            </span>
          )}
        </div>
        <div className="info-item">
          ...
          {editingField === "languages" ? (
            ...
            <span onClick={() => startEditingField("languages")}>
              Idiomas: {getFieldValue("languages") || ""}
            </span>
          )}
        </div>
      </>
    ...
    return (
      <div className="my-data-info-card">
        <div className="my-data-card-header">Sobre mí</div>
